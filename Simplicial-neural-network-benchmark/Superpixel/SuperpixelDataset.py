...
class SuperpixelSCDataset(InMemoryDataset):
    ...
    def process(self):
        ...
        #print(len(self.data_download))
        #print(len([self.data_download[dd] for dd in range(10)]))
        ...
        #data_download_list = [self.data_download[dd] for dd in range(10)]
        #data_list = Parallel(n_jobs=self.n_jobs, prefer="threads") \
        #    (delayed(self.pre_transform)(image) for image in tqdm(data_download_list))
