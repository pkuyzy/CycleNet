from layers.deepsigns import GCNDeepSigns, GINDeepSigns, MaskedGINDeepSigns, GINDeepCycles, GINDeepBasis, MaskedGINDeepBasis, TransformerDeepSigns
...
def get_sign_inv_net(net_params):
    ...
    elif net_params['sign_inv_net'] == 'gin_cycle':
        sign_inv_net = GINDeepCycles(net_params['pos_enc_dim'], net_params['hidden_dim'], net_params['phi_out_dim'], net_params['sign_inv_layers'], net_params['pos_enc_dim'], use_bn=True, dropout=net_params['dropout'], activation=net_params['sign_inv_activation'])
    elif net_params['sign_inv_net'] == 'gin_basis':
        sign_inv_net = GINDeepBasis(net_params['pos_enc_dim'], net_params['hidden_dim'], net_params['phi_out_dim'], net_params['sign_inv_layers'], net_params['pos_enc_dim'], net_params['device'], use_bn=True, dropout=net_params['dropout'], activation=net_params['sign_inv_activation'])
    elif net_params['sign_inv_net'] == 'masked_gin_basis':
        sign_inv_net = MaskedGINDeepBasis(1, net_params['hidden_dim'], net_params['phi_out_dim'], net_params['sign_inv_layers'], net_params['pos_enc_dim'], net_params['device'], use_bn=True, dropout=net_params['dropout'], activation=net_params['sign_inv_activation'])  
