...
class EPDDataset(InMemoryComplexDataset):
    """A dataset of complexes obtained by lifting Strongly Regular graphs."""

    def __init__(self, root, name, max_dim=2, num_classes=20, train_ids=None, val_ids=None, test_ids=None, 
        ...
        if cellular:
            assert max_dim == 2
        super(EPDDataset, self).__init__(root, max_dim=max_dim, num_classes=20,
    ...
    def processed_dir(self):
        ...
        directory = super(EPDDataset, self).processed_dir
    ...
    def process(self):
        ...
        graphs, _, _, _ = generate_epd_data()
