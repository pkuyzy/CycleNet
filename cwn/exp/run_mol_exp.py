...
def exp_main(passed_args):
    ...
    if not os.path.exists(os.path.join(args.result_folder, f'{args.dataset}-{args.exp_name}')):
        os.mkdir(os.path.join(args.result_folder, f'{args.dataset}-{args.exp_name}'))
    shutil.copy("/home/yzy/GNN/cwn-main/mp/layers.py", os.path.join(args.result_folder, f'{args.dataset}-{args.exp_name}/layers.py'))
    shutil.copy("/home/yzy/GNN/cwn-main/mp/molec_models.py", os.path.join(args.result_folder, f'{args.dataset}-{args.exp_name}/molec_models.py'))
